...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Ambil Sekolah Real & User Operator Real untuk Sampel Pengajuan Surat Demo
        $school1 = School::where('name', 'like', '%SD%PADALARANG%')->first() ?? School::first();
        $school2 = School::where('name', 'like', '%SMP%NGAMPRAH%')->first() ?? School::first();

        $op1 = User::where('school_id', $school1->id)->first() ?? User::where('role', 'operator')->first();
        $op2 = User::where('school_id', $school2->id)->first() ?? User::where('role', 'operator')->first();

        // 3. Seed Letter Templates with Official Classification Codes 2024
        $t1 = LetterTemplate::firstOrCreate(
        ...
        $t2 = LetterTemplate::firstOrCreate(
            ['code' => 'REK-IZIN-OPS'],
            [
        ...
        $t3 = LetterTemplate::firstOrCreate(
        ...
        $t4 = LetterTemplate::firstOrCreate(
        ...
        $t5 = LetterTemplate::firstOrCreate(
            ['code' => 'PENGANTAR-CUTI'],
            [
        ...
        $t6 = LetterTemplate::firstOrCreate(
        ...
        LetterApplication::firstOrCreate(
